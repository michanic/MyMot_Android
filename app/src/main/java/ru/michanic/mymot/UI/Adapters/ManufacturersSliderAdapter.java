...
public class ManufacturersSliderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<Manufacturer> manufacturers;
    ClickListener clickListener;

    public ManufacturersSliderAdapter(Context context, List<Manufacturer> manufacturers, ClickListener clickListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof CatalogSliderCell) {
            ((CatalogSliderCell) holder).fillWithManufacturer(manufacturers.get(position));
